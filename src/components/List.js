...
const List = ({ queryType, setQueryType, rating, setRating, placeNames, iconClicked }) => {
    ...
    return (
        <div className="mx-auto font-Josefin">
            <div>
                ...
                <div className="py-2 font-semibold text-lg text-center my-2 mr-4">Restaurants, Hotels and Attractions around you
                </div>
